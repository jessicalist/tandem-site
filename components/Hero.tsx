...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className="hidden lg:block absolute left-0 top-[30px] animate-helix"
        aria-hidden="true"
      >
        <DnaHelix width={90} height={420} opacity={0.35} />
      </div>
      <div
        className="hidden lg:block absolute right-0 bottom-[40px] animate-helix-reverse"
        aria-hidden="true"
      >
        <DnaHelix
          width={90}
      ...
      <div className="relative z-10 max-w-[1120px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-[60px] items-center pb-14">
        ...
        <div className="animate-fade-up">
          ...
          <p className="text-[17px] leading-[1.7] text-white/80 max-w-[540px] mb-[34px]">
            We develop efficient algorithms and computational tools for the
            identification, classification, and biological analysis of{" "}
            <strong>tandem repeats</strong> in genomic sequences — bridging
            string algorithmics with functional genomics.
          </p>
        ...
        <aside className="hidden lg:block bg-white/[0.07] border border-sky-blue/25 rounded-md overflow-hidden backdrop-blur-sm animate-fade-up [animation-delay:0.15s]">
          ...
          />
          <div className="p-5">
            <h2 className="font-heading text-[17px] font-bold text-white mb-1">
              Dr. Dina Sokol
            </h2>
            <p className="text-[13px] text-sky-blue mb-0.5">
              Associate Professor
            </p>
            ...
            <div className="flex flex-col gap-1.5">
              <a
                href="mailto:dsokol@brooklyn.cuny.edu"
                className="text-[13px] text-white/70 no-underline hover:text-sky-blue transition-colorsduration-200"
              >
